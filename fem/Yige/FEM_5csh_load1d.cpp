...
//YZ:added 200212
std::ofstream stress_fout("stress_5csh_1d.txt"); // store stresses of each CSH after equilibrium of each step
std::ofstream phasechange_fout("phasechange_5csh_1d.txt"); // store phase change at which pixel
std::ofstream phasechange_csh_fout("phasechange_5csh_csh_1d.txt"); // store phase change at which pixel (only for CSH)
std::ofstream fout("outputfile_5csh_1d.txt"); // store the bulk stress due to applied strains
