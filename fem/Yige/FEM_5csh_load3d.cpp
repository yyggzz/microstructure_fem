...
//YZ:added 200212
std::ofstream stress_fout("stress_5csh_3d.txt"); // store stresses of each CSH after equilibrium of each step
std::ofstream phasechange_fout("phasechange_5csh_3d.txt"); // store phase change at which pixel
std::ofstream phasechange_csh_fout("phasechange_5csh_csh_3d.txt"); // store phase change at which pixel (only for CSH)
std::ofstream fout("outputfile_5csh_3d.txt"); // store the bulk stress due to applied strains
...
void materials(){
	...
	step = 13; //step number should be equal to number of Thames microstructure images
...
{	
	...
	*/
	...
	string prefilename[14]; //file number should be equal to number of Thames microstructure images
	char filename[15];

	prefilename[1] = "14.img";
	prefilename[2] = "15.img";
	prefilename[3] = "16.img";
	
	prefilename[4] = "17.img";
	prefilename[5] = "18.img";
	prefilename[6] = "19.img";
	prefilename[7] = "20.img";
	prefilename[8] = "21.img";
	prefilename[9] = "22.img";
	prefilename[10] = "23.img";
	prefilename[11] = "24.img";
	prefilename[12] = "25.img";
	prefilename[13] = "26.img";
