...
//YZ:added 200212
std::ofstream stress_fout("stress_5csh_1d_release14d.txt"); // store stresses of each CSH after equilibrium of each step
std::ofstream phasechange_fout("phasechange_5csh_1d_release14d.txt"); // store phase change at which pixel
std::ofstream phasechange_csh_fout("phasechange_5csh_csh_1d_release14d.txt"); // store phase change at which pixel (only for CSH)
std::ofstream fout("outputfile_5csh_1d_release14d.txt"); // store the bulk stress due to applied strains
...
void materials(){
	...
	step = 17; //step number should be equal to number of Thames microstructure images
...
{	
	...
	*/
	...
	string prefilename[18]; //file number should be equal to number of Thames microstructure images
	char filename[15];
	...
	prefilename[4] = "13.img";
	prefilename[5] = "14.img";
	prefilename[6] = "15.img";
	prefilename[7] = "16.img";
	prefilename[8] = "17.img";
	prefilename[9] = "18.img";
	prefilename[10] = "19.img";
	prefilename[11] = "20.img";
	prefilename[12] = "21.img";
	prefilename[13] = "22.img";
	prefilename[14] = "23.img";
	prefilename[15] = "24.img";
	prefilename[16] = "25.img";
	prefilename[17] = "26.img";
	...
	{
		if (q==13) { //at 14d, release strain
			exx = 0.0; // triaxial compression
			eyy = 0.0;
			ezz = 0.0;
			exz = 0.0;
			eyz = 0.0;
