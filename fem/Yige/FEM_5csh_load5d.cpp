...
//YZ:added 200212
std::ofstream stress_fout("stress_5csh_5d.txt"); // store stresses of each CSH after equilibrium of each step
std::ofstream phasechange_fout("phasechange_5csh_5d.txt"); // store phase change at which pixel
std::ofstream phasechange_csh_fout("phasechange_5csh_csh_5d.txt"); // store phase change at which pixel (only for CSH)
std::ofstream fout("outputfile_5csh_5d.txt"); // store the bulk stress due to applied strains
...
void materials(){
	...
	step = 10; //step number should be equal to number of Thames microstructure images
...
{	
	...
	*/
	...
	string prefilename[11]; //file number should be equal to number of Thames microstructure images
	char filename[15];

	prefilename[1] = "17.img";
	prefilename[2] = "18.img";
	prefilename[3] = "19.img";
	
	prefilename[4] = "20.img";
	prefilename[5] = "21.img";
	prefilename[6] = "22.img";
	prefilename[7] = "23.img";
	prefilename[8] = "24.img";
	prefilename[9] = "25.img";
	prefilename[10] = "26.img";
